...
ActiveRecord::Schema.define(version: 2023_12_13_092131) do
  ...
  create_table "group_approvals", force: :cascade do |t|
    t.integer "player_id"
    t.integer "group_id"
  ...
  create_table "players", force: :cascade do |t|
    ...
    t.string "addicted_game", null: false
    t.integer "play_style", default: 0, null: false
